export interface localization {
  ...
  inviteEditor: string,
  copied: string,
  takeAwayTheAbilityToEdit: string,
  perform: string,
  // board
  yourBoards: string,
  settings: string,
...
const loc: localizationConfig = {
  en: {
    ...
    copied: 'Copied',
    takeAwayTheAbilityToEdit: 'Take away the ability to edit',
    perform: 'Perform',
    // board
  ...
  ru: {
    ...
    share: 'Поделиться',
    inviteEditor: 'Пригласить редактора',
    copied: 'Скопировано',
    takeAwayTheAbilityToEdit: 'Забрать возможность редактирования',
    perform: 'Выполнить',
    // board
