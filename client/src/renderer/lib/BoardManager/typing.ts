...
// board message
export type BoardMessage = Join | Quit | UndoRedo | Push | PushSegment | Pull | Info | Empty | SetSize | SetTitle
export type MessageType = 'Join' | 'Quit' | 'UndoRedo' | 'Empty' | 'Push' | 'PushSegment' | 'Pull' | 'Info' | 'SetSize' | 'SetTitle'
// errors
